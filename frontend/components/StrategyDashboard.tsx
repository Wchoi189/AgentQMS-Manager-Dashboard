...
import { Database, Layers, GitBranch, Search, Lightbulb, Loader2, Activity, CheckCircle } from 'lucide-react';
...
interface SystemStats {
    totalDocs: number;
    distribution: { name: string; valid: number }[];
}
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-slate-900 border border-slate-700 p-4 rounded-lg">
                        <div className="text-slate-400 text-xs font-semibold uppercase mb-1">Backend API</div>
                    ...
                    <div className="bg-slate-900 border border-slate-700 p-4 rounded-lg">
                        <div className="text-slate-400 text-xs font-semibold uppercase mb-1">Tracking DB</div>
                        <div className="flex items-center gap-2">
                            {/* We assume connected if frontend loads, ideally query /tracking/health */}
                            <CheckCircle className="text-green-500 w-4 h-4" />
                            <span className="text-white font-medium">Online</span>
                        </div>
                    </div>
                    <div className="bg-slate-900 border border-slate-700 p-4 rounded-lg">
                        <div className="text-slate-400 text-xs font-semibold uppercase mb-1">File System</div>
                        <div className="flex items-center gap-2">
                            <CheckCircle className="text-green-500 w-4 h-4" />
                    ...
                    <div className="bg-slate-900 border border-slate-700 p-4 rounded-lg">
                        <div className="text-slate-400 text-xs font-semibold uppercase mb-1">Git Repository</div>
                        <div className="flex items-center gap-2">
                            <GitBranch className="text-purple-500 w-4 h-4" />
